      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center bg-black p-4 md:p-8">
            ...
            <div className="w-full md:w-1/3 flex justify-center mb-6 md:mb-0">
              <img
                src="https://dragontigerclub.tech/wp-content/uploads/2025/09/DTC-logo-300x300.png"
                alt="Dragon Tiger Club - Fast-paced card game with rewards"
            ...
            <div className="w-full md:w-2/3 flex flex-col items-center md:items-start text-center md:text-left px-2 md:px-6">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent leading-snug">
                Dragon Tiger Club APK
                
              </h1>

              {/* Responsive Paragraph */}
              <p className="text-gray-200 text-sm sm:text-base md:text-lg max-w-2xl mb-4 md:mb-6">
                Download, register and enjoy fast-paced card action with rewards in
                Pakistan.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto justify-center md:justify-start">
                <a
                  href="https://dragontigerclub.net/?from_gameid=5129078&channelCode=5128469"
                  ...
                  aria-label="Download Dragon Tiger Club APK"
                >
                  <Download className="h-5 w-5" /> Download Dragon Tiger Club
                </a>
                <a
                  href="https://dragontigerclub.net/?from_gameid=5129078&channelCode=5128469"
            ...
            <table className="min-w-full text-gray-300 border border-gray-700 rounded-lg overflow-hidden">
              <tbody>
                <tr className="bg-gray-800/50">
                  ...
                  <td className="px-3 py-2 md:px-4 md:py-3">Dragon Tiger Club</td>
                </tr>
                <tr>
                  <td className="px-3 py-2 md:px-4 md:py-3 font-medium">Publisher</td>
                  <td className="px-3 py-2 md:px-4 md:py-3">DragonTigerClub</td>
                </tr>
                <tr className="bg-gray-800/50">
                  <td className="px-3 py-2 md:px-4 md:py-3 font-medium">Version</td>
                  <td className="px-3 py-2 md:px-4 md:py-3">v1.129</td>
                </tr>
                <tr>
                  <td className="px-3 py-2 md:px-4 md:py-3 font-medium">Size</td>
                  <td className="px-3 py-2 md:px-4 md:py-3">47MB</td>
                </tr>
                <tr className="bg-gray-800/50">
                  <td className="px-3 py-2 md:px-4 md:py-3 font-medium">Rating Count</td>
                  <td className="px-3 py-2 md:px-4 md:py-3">10,900</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            {[
              {
                ...
                title: "Play & Earn",
                desc: "Install the app, enjoy games, and unlock rewards as you play.",
              },
              {
              ...
              },
              {
                ...
                desc: "Includes Dragon Tiger, Ludo, Roulette, Mines and more.",
              },
              {
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
            {[
              {
                src: "DTCscreenshot1.jpg",
                alt: "Dragon Tiger Club gameplay screenshot 1",
              },
              {
                src: "DTCscreenshot1.jpg",
                alt: "Dragon Tiger Club gameplay screenshot 2",
              },
              {
                src: "DTCscreenshot3.jpg",
                alt: "Dragon Tiger Club gameplay screenshot 3",
              },
            ].map((img, i) => (
              <motion.div
                key={i}
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed text-sm md:text-base">
            ...
            is one of the most engaging card apps in Pakistan, offering
            fast-paced gameplay and rewards. Download today and start enjoying
            casual entertainment with friends!
          </p>
        </motion.div>
      </div>
    </div>
...
export default DragonTigerClubPage;