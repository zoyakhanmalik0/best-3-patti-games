      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center bg-black p-4 md:p-8">
            ...
            <div className="w-full md:w-1/3 flex justify-center mb-6 md:mb-0">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRER8EFNBuzPVKI1QWCFPjGZyl4ttYQKCAOzg&s"
                alt="3 Patti No 1 - Popular card game with rewards"
            ...
            <div className="w-full md:w-2/3 flex flex-col items-center md:items-start text-center md:text-left px-2 md:px-6">
              ...
              <p className="text-gray-200 text-sm sm:text-base md:text-lg max-w-2xl mb-4 md:mb-6">
                Download, register and enjoy exciting 3 Patti action with rewards in Pakistan.
              </p>

              {/* Responsive Buttons */}
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto justify-center md:justify-start">
                <a
                  href="https://3pattino1.com/?from_gameid=6372811&channelCode=6362528"
                ...
                >
                  <Download className="h-5 w-5" /> Download 3 Patti No 1
                </a>
                <a
                  href="https://3pattino1.com/?from_gameid=6372811&channelCode=6362528"
                  rel="noopener noreferrer"
            ...
            {[
              {
                ...
                title: "Play & Earn",
                desc: "Install the app, play Teen Patti, and unlock rewards as you play.",
              },
              {
              ...
              },
              {
                ...
                desc: "Includes Teen Patti, Ludo, Rummy, Dragon Tiger and more.",
              },
              {
            ...
            {[
              {
                ...
                alt: "3 Patti No 1 gameplay screenshot 1",
              },
              {
                src: "DTCscreenshot2.jpg",
                alt: "3 Patti No 1 gameplay screenshot 2",
              },
              {
                src: "DTCscreenshot3.jpg",
                alt: "3 Patti No 1 gameplay screenshot 3",
              },
            ].map((img, i) => (
              <motion.div
                key={i}
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed text-sm md:text-base">
            ...
            is one of the most exciting card apps in Pakistan, offering
            thrilling gameplay and rewards. Download today and start enjoying
...
export default ThreePattiNo1Page;
